...
public:
    ...
    ssize_t indexOfAttribute(const uint16_t* ns, size_t nsLen,
...
public:
    ...
    const uint16_t* valueToString(const Res_value* value, size_t stringBlock,
                                  uint16_t tmpBuffer[TMP_BUFFER_SIZE],
                                  size_t* outLen);
    ...
    uint32_t identifierForName(const uint16_t* name, size_t nameLen,
                               const uint16_t* type = 0, size_t typeLen = 0,
                               const uint16_t* defPackage = 0,
    ...
    static bool stringToInt(const uint16_t* s, size_t len, Res_value* outValue);
    static bool stringToFloat(const uint16_t* s, size_t len, Res_value* outValue);
    ...
    const uint16_t* getBasePackageName(size_t idx) const;
